...
public class Task4Map {
  ...
  public void addObject(Object object) {
    ...
    if (object instanceof Task4Monster[]) {
      for (Task4Monster monster : ((Task4Monster[])object)) {
        pos = monster.getPos();
  ...
  public void update(Task4Soldier soldier, int oldRow, int oldColumn, int newRow, int newColumn) {
